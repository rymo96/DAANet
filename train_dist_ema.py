...
def get_args():
    parser = argparse.ArgumentParser("DAANet")
    ...
    parser.add_argument('--num-epochs', type=int, default=300, help='total epochs')
...
def main():
    ...
    args.train_dir = os.path.join(args.data_dir, "train.lmdb")
    args.val_dir = os.path.join(args.data_dir, "val.lmdb")
    ...
    train_dataset = ImageFolderLMDB(args.train_dir, train_transforms)
    ...
    val_dataset = ImageFolderLMDB(args.val_dir, val_transforms)
    ...
    args.save_interval = iters_epoch * 5
